...
# 绘制地震震源位置
gawk '{print $2,$3}' $file | gmt psxy -J$J -R$R -Sc0.06i -Gblue -K -O >> $PS

# 绘制30和60度等震中距线
echo $stlo $stla 6672 | gmt psxy -J$J -R$R -SE- -K -O -W1p,red >> $PS
echo $stlo $stla 13344 | gmt psxy -J$J -R$R -SE- -K -O -W1p,red >> $PS
echo $stlo $stla 20016 | gmt psxy -J$J -R$R -SE- -K -O -W1p,red >> $PS
